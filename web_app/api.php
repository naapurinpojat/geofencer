...
function generateDogSvg($text) {
    // SVG content representing a dog with a "Hello" text
    $svgContent = '<svg xmlns="http://www.w3.org/2000/svg" width="400" height="200">
        <!-- Dog -->
